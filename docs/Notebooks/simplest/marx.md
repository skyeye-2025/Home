...
这是我的马原笔记，基于《马克思主义基本原理 2023年版》和方瑞老师2025春夏学期《马克思主义基本原理》。我在复习期间一边看教材一边记录下我认为重要的内容，覆盖全书大部分考点（毕竟我真的是看全书记下来的），适合于想要节省时间，不想看完全书的同学。
...
用历史分析方法和阶级分析方法来分析历史人物。历史分析方法就是全面客观看到功过，阶级分析方法就是结合历史人物所在阶级来考察。
...
资本的技术构成是由生产的技术水平所决定的生产资料和劳动力之间的比例。资本的价值构成是不变资本和可变资本之间的比例。

资本的有机构成，课本的表述是“一般来说，资本的技术构成决定资本的价值构成，技术构成的变化往往会引起价值构成的相应变化，而价值构成的变化通常反映技术构成的变化。这种由资本的技术构成决定并反映技术构成变化的资本价值构成，叫作资本的有机构成。”，资本的有机构成在计算时和资本价值构成的表达式一样，都是c:v。但是在概念上，它是排除了价格波动干扰后的、纯粹反映生产技术水平的资本价值构成。这部分确实比较微妙（我也不太明白），建议自己问问AI“资本的价值构成和有机构成有什么区别”，从它举的例子感受一下

资本主义生产追求提高剩余价值，提高资本的有机构成（也就是通过技术进步让不变资本增加，可变资本减少），使得劳动力需求减少，造成失业。
...
资本主义意识形态有进步意义，推动了历史前进，但仍然具有阶级压迫的局限性。

![](https://skyeyesandox-1374084537.cos.ap-shanghai.myqcloud.com/202601061712345.png)
